...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.neuronomixer.com/visual-guides/confidence-intervals" },
  openGraph: {
    title: "Confidence Intervals: What They Actually Mean — NeuroNomixer",
    description: "Interactive visualization of repeated sampling confidence intervals showing coverage and width tradeoffs.",
  ...
  twitter: {
    ...
    title: "Confidence Intervals: What They Actually Mean",
    description: "See how confidence intervals work through repeated sampling visualization.",
  },
};
