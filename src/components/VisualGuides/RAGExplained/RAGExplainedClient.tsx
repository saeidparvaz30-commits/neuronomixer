...
const STEPS = [
  ...
  { id: "answer", label: "Grounded Answer", icon: "✅", color: "#d4af37", group: "generate", desc: "LLM generates an answer grounded in retrieved context, with citations and low hallucination." },
] as const;
...
export default function RAGExplainedClient() {
  ...
  const { fadeUp, stagger, card } = useGuideMotion();
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-10 py-8">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[12px] text-[#475569] mb-6">
          ...
          <span>/</span>
          <span className="text-[#94a3b8]">RAG: Retrieval Augmented Generation</span>
        </nav>
        ...
        <section className="mb-10">
          ...
          >
            RAG: <span className="text-[var(--color-accent)]">Retrieval Augmented Generation</span>
          </motion.h1>
          <motion.p
            variants={fadeUp}
            initial="hidden"
        ...
        <section className="mb-14">
          ...
          {stage !== "idle" && (
            <div className="space-y-4">
              {/* Step 1 */}
              <motion.div variants={fadeUp} initial="hidden" animate="visible" className="rounded-2xl border border-[#1e293b] bg-[#0f172a] p-4">
              ...
              {showPrompt && (
                <motion.div variants={fadeUp} initial="hidden" animate="visible" className="rounded-2xl border border-[#1e293b] bg-[#0f172a] p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-5 h-5 rounded-full bg-[var(--color-accent)] flex items-center justify-center text-[10px] font-bold text-[#0a0e1a]">✓</div>
              ...
              {/* Step 4: Answer */}
              {showAnswer && (
                <motion.div variants={fadeUp} initial="hidden" animate="visible" className="rounded-2xl border border-[#3bb4a4]/40 bg-[#3bb4a4]/5 p-4">
                  <div className="flex items-center gap-2 mb-2">
        ...
        <section className="mb-14">
          ...
          <div className="rounded-2xl border border-[#1e293b] bg-[#0f172a] overflow-hidden">
            <div className="grid grid-cols-3 bg-[#1e293b]">
              ...
              <div className="px-4 py-3 text-[11px] font-bold uppercase tracking-wider text-[var(--color-accent)]">Fine-Tuning</div>
            </div>
            {TABLE.map((row, i) => (
              <div key={row.aspect} className={`grid grid-cols-3 border-t border-[#1e293b] ${i % 2 === 0 ? "bg-[#0f172a]" : "bg-[#162032]"}`}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[13px] text-white leading-relaxed">
                ...
                means the right context is never retrieved, and even the best LLM can&apos;t help then.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="px-6 pt-6 pb-4 border-b border-white/[0.07]">
                ...
                <h2 className="text-2xl font-extrabold tracking-tight text-white">
                  RAG Pipeline Mastered!
                </h2>
                <p className="text-sm text-[#94a3b8] mt-1">
                  You explored all 8 pipeline steps and ran {queriesRun} live retrieval simulations.
                </p>
              </div>
              ...
              <div className="px-6 py-5">
                <p className="text-[13px] text-[#94a3b8] leading-relaxed mb-4">
                  You watched documents get chunked, embedded, and indexed, then saw a query
                  retrieve the right context and ground the model&apos;s answer. You also
                  compared RAG against fine-tuning and know when each fits.
                </p>
                ...
                <div className="rounded-xl border-l-4 border-[var(--color-accent)] bg-[#d4af37]/5 border border-[#d4af37]/20 p-4 mb-2">
                  ...
                  <p className="text-[13px] text-[#94a3b8] leading-relaxed italic">
                    &quot;The retrieval step is often the bottleneck. A bad embedding model or
                    chunking strategy means the right context is never retrieved, and even the
                    best LLM can&apos;t help then.&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="px-6 py-4 border-t border-white/[0.07] flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href="/visual-guides/vector-databases"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-6 border-t border-white/[0.06]">
          ...
          <Link href="/visual-guides/vector-databases" className="px-5 py-2 rounded-xl text-sm font-semibold bg-[var(--color-accent)] text-[#0a0e1a] hover:opacity-90 transition-opacity">
            Next Guide →
          </Link>
        </div>
      </div>
