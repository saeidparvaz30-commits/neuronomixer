    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
      <div className="lg:col-span-3 rounded-2xl border border-[#1e293b] bg-[#0f172a] p-4">
        ...
        >
          ...
          <text x={M.l} y={H - M.b + 16} fill="#475569" fontSize={10} textAnchor="middle">
            {xMin.toFixed(1)}
          </text>
          <text x={W - M.r} y={H - M.b + 16} fill="#475569" fontSize={10} textAnchor="end">
            {xMax.toFixed(1)}
          </text>
          <text x={M.l - 6} y={H - M.b} fill="#475569" fontSize={10} textAnchor="end">
            {yMin.toFixed(1)}
          </text>
          <text x={M.l - 6} y={M.t + 8} fill="#475569" fontSize={10} textAnchor="end">
            {yMax.toFixed(1)}
          </text>
