...
export const STAGE_CONFIGS = [
  ...
  { id: "collection"     as StageId, index: 1, color: "var(--color-warning)", title: "Collection",     tagline: "Pulling data from multiple sources into one place"    },
  ...
  { id: "analysis-ready" as StageId, index: 4, color: "var(--color-accent)", title: "Analysis-Ready", tagline: "Clean, structured, and ready for insights"           },
];
