...
export type IssueType = "missing" | "outlier" | "duplicate" | "type-error";
...
export const PIPELINE_STAGES: PipelineStage[] = [
  ...
  },
  {
    ...
    outputLabel: "12 records + 5 flags",
  },
  {
    id: "clean",
    label: "Clean",
    ...
    detail: "Nulls imputed with median, duplicates dropped, salary outlier capped, department typo corrected.",
    tools: ["Pandas", "dbt", "OpenRefine", "Spark"],
    outputLabel: "10 clean records",
  },
  {
    id: "transform",
    label: "Transform",
    ...
    detail: "Salary normalized to z-scores, department one-hot encoded, seniority tier derived from age + salary.",
    tools: ["scikit-learn", "Pandas", "dbt", "Spark"],
    outputLabel: "10 records × 8 features",
  },
  {
    id: "aggregate",
    label: "Aggregate",
...
export const RAW_DATA: DataRow[] = [
  ...
  { id: 12, name: "Leo",    age: "thirty" as unknown as number, salary: 74000, dept: "Marketing", issues: ["type-error"] },
];
...
export const ISSUE_META: Record<IssueType, { label: string; color: string; desc: string }> = {
  ...
  duplicate:  { label: "Duplicate",  color: "#8b5cf6", desc: "Row matches another row" },
  "type-error": { label: "Type Error", color: "#eab308", desc: "Wrong data type or typo" },
};
