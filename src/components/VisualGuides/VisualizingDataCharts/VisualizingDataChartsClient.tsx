  ...
  useEffect(() => {
    if (isComplete && !completionFired.current && session?.user) {
      ...
      fetch("/api/visual-guides/complete", {
        ...
        body: JSON.stringify({ guideSlug: "visualizing-data-charts", score: 8 }),
      }).catch(() => {});
    }
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-10 py-8">
        ...
        <section className="mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-white mb-3">
            Visualizing Data:{" "}
            <span className="text-[#d4af37]">Charts That Tell the Truth</span>
          </h1>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#d4af37]/10 border border-[#d4af37]/30 flex items-center justify-center">
              <span className="text-[12px] font-bold text-[#d4af37]">1</span>
            </span>
            <div>
